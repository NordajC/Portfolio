...
//       <div className='rounded-lg cursor-pointer hover:scale-105 transition-all w-fit px-5 py-2 m-3 border-grey-400/60 rounded-lg rounded-lg bg-[#333333] border-[#cccccc] pointer'>
  ...
  return (
    <>
      ...
      {isModalOpen && (
        ...
        >
          <div
            className="bg-white w-full h-full p-5 relative flex flex-col items-center justify-center max-w-none"
          ...
          >
            ...
            <h2 className="text-2xl font-bold">Queen Mary University of London</h2>
            <p className="mt-4 text-center text-lg">
              BSC (Eng) Creative Computing Hons Achieved First Class
            </p>
            <h2 className="text-2xl font-bold">Into Manchester College</h2>
            <p className="mt-4 text-center text-lg">
              Achieved A* for Maths for Engineering,
              Physcis, and Chemistry
            </p>
          </div>
        </div>
      )}
